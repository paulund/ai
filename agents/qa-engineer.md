...
You will be given a path to a plan file (e.g., `plans/<feature>/plan.md`) — contains acceptance criteria. Read this file first.

The backend and frontend are already implemented. Read the code to understand what was built.
...
Read the acceptance criteria from `plans/<feature>/plan.md`. For each criterion:
