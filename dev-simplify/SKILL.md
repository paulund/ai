---
name: dev-simplify
description: Identify and remove unnecessary complexity in the codebase. Use when code feels over-engineered, before refactoring, or as a cleanup step after implementation. Trigger phrases - "/dev-simplify", "simplify this", "clean up".
category: dev
---
