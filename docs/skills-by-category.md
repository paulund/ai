...
Manually triggered skills mapped to the [Development Workflow](./development-workflow.md) stages.
...
Content creation, strategy, SEO, and social media skills.
...
Product planning, pricing, and launch readiness skills.
...
Text improvement and technical writing skills.

| Skill | Description |
|-------|-------------|
| `writing-humanizer` | Remove AI-generated patterns from text |
